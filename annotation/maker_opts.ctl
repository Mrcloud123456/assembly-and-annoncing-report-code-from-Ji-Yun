...
genome=pilon.fasta #genome sequence (fasta file or fasta embeded in GFF3 file)
...
rmlib=/data/courses/assembly-annotation-course/CDS_annotation/EDTA_v1.9.6_new/Ler_flye.fasta.mod.EDTA.TElib.fa #provide an organism specific repeat library in fasta format for RepeatMasker
...
TMP= /data/users/jyun/annotation/maker #specify a directory other than the system default temporary directory for temporary files
